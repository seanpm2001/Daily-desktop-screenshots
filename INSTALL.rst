...
----
Installing Daily-desktop-screenshots
----

Daily-desktop-screenshots currently doesn't require installation, it is just a collection of images and data. It is part of the Seanpm2001 Life Archive project, and for proper "installation" the repository should be placed under /SeansLifeArchive/<yourInstalledVersion>/Resources/Images/

If you want to load the first project language file, you will need to have an Makefile IDE/Interpreter and a package of any version of the GNU Make utility prior to version 1.0
...
----
Install instructions file version: 2 (2022, Saturday, March 19th at 6:12 pm)
----
